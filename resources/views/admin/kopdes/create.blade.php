...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tambah KopDes</h1>
            <p class="text-sm text-gray-500 mt-1">Masukkan informasi koperasi desa baru</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
        <form method="POST" action="{{ route('kopdes.store') }}" class="space-y-6">
            @csrf
